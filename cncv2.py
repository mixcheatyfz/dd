...
def layer7():
	os.system ("clear")
	print("""
\033[37m           ,MMM\033[35m8&&&.           WELCOME TO - DEATHPANEEL
\033[37m      _...MMMMM\033[35m88&&&&..._      BOTI
\033[37m   .::'''MMMMM8\033[35m8&&&&&&'''::.   V2 TEAM Version, 1.2
...
def main():
	...
	while True:
		sys.stdout.write(f"\x1b]2;[/] DEATH Pannel :: Server Online 500 :: Online 1 :: Running: 0/10\x07")
		sin = input("\033[0;30;45mDEATH@PANNEL\x1b[1;37m\033[0m:~# \x1b[1;37m\033[0m ")
		sinput = sin.split(" ")[0]
		if sinput == "clear":
			os.system ("clear")
			menu()
...
\033[1;37m                   USER     : \033[35m[ \033[1;37mboti \033[35m]
\033[35m           ╚════════════════════════════════════════════════════════╝
""")
			except ValueError:
				main()
...
def login():
    ...
    if username != user or password != passwd:
        ...
        print("""                                              
                         ⚡ \33[0;32mWELLCOME TO V2 TEAM DDOS""")
        time.sleep(0.3)
    menu()
    main()
